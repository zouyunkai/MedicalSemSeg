...
class SwinTransformerBlock3D(nn.Module):
    ...
    def __init__(self, dim, num_heads, window_size=(6, 6, 6), shift_size=(0, 0, 0),
...
class PatchMerging(nn.Module):
    ...
    def forward(self, x):
        ...
        # Removed padding until its needed.
        '''
        # padding
        ...
        x2 = x[:, 1::2, 1::2, 0::2, :]  # B D/2 H/2 W/2 C
        ...
        x7 = x[:, 0::2, 1::2, 0::2, :]  # B D/2 H/2 W/2 C
