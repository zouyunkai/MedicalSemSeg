...
class UNETRSmall(nn.Module):
    def __init__(self, encoder, in_chans=1, output_dim=3):
        ...
        self.decoder12_upsampler = \
            SingleDeconv3DBlock(self.embed_dim, 256)

        self.decoder8_upsampler = \
            nn.Sequential(
                Conv3DBlock(512, 256),
                Conv3DBlock(256, 256),
                Conv3DBlock(256, 256),
    ...
    def forward(self, x):
        ...
        z8 = self.decoder8(z8)
        z8 = self.decoder8_upsampler(torch.cat([z8, z12], dim=1))
        z4 = self.decoder4(z4)
