...
from models.segmentors.nnformer_official.neural_network import SegmentationNetwork
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, mask_matrix):
        ...
        assert L == S * H * W, "input feature has wrong size. Input size: {}, expected size: {}".format(x.shape, self.input_resolution)
